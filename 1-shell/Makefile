...
TARGET = 42sh
SOURCES = front.c shell.c parser/ast.c mc.c arena.c $(ADDITIONAL_SOURCES)
HEADERS = parser/lexer.h parser/ast.h shell.h mc.h arena.h front.h $(ADDITIONAL_HEADERS)
